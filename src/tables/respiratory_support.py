...
CLIF_RESP_SCHEMA = pa.DataFrameSchema(
    {
        ...
        "device_category": pa.Column(str, checks=[pa.Check.isin(RESP_DEVICE_RANK)], nullable=True),
        "vent_brand_name": pa.Column(str, nullable=True),
        "mode_name": pa.Column(str, nullable=True),
        "mode_category": pa.Column(str, checks=[pa.Check.isin(MODE_CATEGORIES)], nullable=True),
